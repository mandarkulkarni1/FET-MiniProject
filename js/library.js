$(document).ready(function () {
  ...
  $("#category .card").on("click", function () {
    ...
    window.location.href = "list.html";             //Navigate to the album list page
  });
  ...
  $("#artists .card").on("click", function () {
    ...
    sessionStorage.setItem("section", selectedSection); //Storing page section(artist) selected in session variable
  ...
  $(".recent-song-container").on("click", ".card", function (e) {
